...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>BPS Kab. Probolinggo</title>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-8  col-xs-12">
                        <div class="header-half header-call">
                            <p>
                                <span><i class="pe-7s-call"></i> +62 8533 0183 550</span>
                                <span><i class="pe-7s-mail"></i> putribudiasih18@gmail.com</span>
                            </p>
                        </div>
                    </div>
        ...
        <nav class="navbar navbar-default ">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="assets/img/logoBPS.png" alt="" height="80" width="80"></a>
                </div>
            ...
            <div class="slider-content">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12">
                        <h2>BADAN PUSAT STATISTIK KABUPATEN PROBOLINGGO</h2>
                        ...
                        <div class="search-form wow pulse" data-wow-delay="0.8s">
                            ...
                            <form action="" class=" form-inline">
                                ...
                                <div class="form-group">                                   
                                    <select id="lunchBegins" class="selectpicker" data-live-search="true" data-live-search-style="begins" title="Nama">
            ...
            <div class="container">
                <div class="row">
                   ...
                   <!-- <div class="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0 col-xs-12">
                    ...
                    <div class="col-xs-12">
                        <p  class="asks-call">QUESTIONS? CALL US  : <span class="strong"> + 085330183550</span></p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <ul class="footer-adress">
                                    ...
                                    <li><i class="pe-7s-mail strong"> </i> putribudiasih18@gmail.com</li>
                                    <li><i class="pe-7s-call strong"> </i> +62 8533 0183 550</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
